...
public class AutoPlant : Module
{
    ...
    {
        public List<PlantType> targetPlantTypes = new();
    ...
    public override void OnUpdateActive()
    {
        ...
        List<CardUI> availableCards = new();
        ...
        Dictionary<Vector2Int, GhostPlantRequest> activeGhostsByTile = new();
        foreach (var req in PendingPlants)
        {
            if (req.isProjectedSpread) continue;

            Vector2Int pos = new(req.column, req.row);
        ...
        for (int i = availableCards.Count - 1; i >= 0; i--)
        {
            ...
            List<GhostPlantRequest> candidates = new();
