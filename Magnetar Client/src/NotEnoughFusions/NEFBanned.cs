...
public static class NEFBanned
{
    ...
    public static HashSet<int> InitBannedIDs = new()
    {
        233,247,
        246,257,258,259,260,261,262,263,264,265,266,267,268,269,270,271,272,273,274,275,350,351,352,353,354,
    ...
    public static HashSet<int> InitHiddenIDs = new()
    {
